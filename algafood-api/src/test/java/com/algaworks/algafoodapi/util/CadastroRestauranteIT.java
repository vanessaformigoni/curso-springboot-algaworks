...
public class CadastroRestauranteIT {
    ...
    public void setUp() {
        ...
        jsonRestauranteCorreto = ResourceUtils.getContentFromResource(
                "/json/correto/restaurante-judaico.json");

        jsonRestauranteSemFrete = ResourceUtils.getContentFromResource(
                "/json/incorreto/restaurante-judaico-sem-frete.json");

        jsonRestauranteSemCozinha = ResourceUtils.getContentFromResource(
                "/json/incorreto/restaurante-judaico-sem-cozinha.json");

        jsonRestauranteComCozinhaInexistente = ResourceUtils.getContentFromResource(
                "/json/incorreto/restaurante-judaico-com-cozinha-inexistente.json");
    ...
    public void deveRetornarStatus400_QuandoCadastrarRestauranteSemTaxaFrete() {
        ...
        .then()
                ...
                .body("title", CoreMatchers.equalTo("Mensagem incompreensível")); //CoreMatchers.equalTo(DADOS_INVALIDOS_PROBLEM_TITLE)
    }
    ...
    public void deveRetornarStatus400_QuandoCadastrarRestauranteComCozinhaInexistente() {
        ...
        .then()
                .statusCode(HttpStatus.BAD_REQUEST.value())
                .body("title", CoreMatchers.equalTo("Mensagem incompreensível")); //equalTo(VIOLACAO_DE_REGRA_DE_NEGOCIO_PROBLEM_TYPE));
    }
    ...
    public void deveRetornarRespostaEStatusCorretos_QuandoConsultarRestauranteExistente() {
        ...
        .then()
                .statusCode(HttpStatus.OK.value())
                .body("nome", CoreMatchers.equalTo(burgerTopRestaurante.getNome()));
    }
